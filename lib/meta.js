...
var addGetter = function (name) {
  ...
  this['get' + name] = function (path, callback) {
    this.service.bus.getObject(path, 'org.PulseAudio.Core1.' + name, callback);
  }
...
module.exports = Object.create({
  ...
  addSignals: function (cls, signals) {
    cls.prototype._known_signals = signals;
    ...
    cls.prototype.on = function () {
      ...
      signal = (Object.keys(this._known_signals).indexOf(signal) >= 0)
        ? this._known_signals[signal]
        : signal;
